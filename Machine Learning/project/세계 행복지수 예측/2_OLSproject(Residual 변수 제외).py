...
print("점수 기준 Accurency :", correct/total*100, "%")

# 등수 기준으로 결과 확인
total = len(predict2018)
correct = len(predict2018[ abs(predict2018['Happiness Rank'] - predict2018['Predict Rank']) < 15])
print("등수 기준 Accurency :", correct/total*100, "%")

# 실제값과 예측값에 대한 산점도
import matplotlib.pyplot as plt
plt.scatter(predict2018['Happiness Rank'], predict2018['Happiness Score'])
plt.scatter(predict2018['Happiness Rank'], predict2018['Predict Score'])
plt.xlabel('Country')
